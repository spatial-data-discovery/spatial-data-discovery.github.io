...
The data were visualized in python with matplotlib[^mpl] and geopandas[^gpd]. For each year, the corresponding gun law grades are plotted as a choropleth visualization. For each month within that year, the mass shootings that occurred on that date are selected and plotted on top of the choropleth map. A plot for each month and year between January 2009 and September 2020 was generated. Each plot functioned as a frame in the animation. 
