...
<div class="video-wrapper">
  ...
  <video id="scaledvideo" controls preload="true" autoplay loop muted>
    ...
    <source src="https://drdavis.space/teaching/ds/sdd/media/2020/05/sst.mp4" >

  </video>

</div>

> *El Niño (/ɛl ˈniːn.joʊ/; Spanish: [el ˈniɲo]) is the warm phase of the El Niño–Southern Oscillation (ENSO). The ENSO is the cycle of warm and cold sea surface temperature (SST) of the tropical central and eastern Pacific Ocean.* -- Wikipedia
...
El Niño and La Niña are the warm and cold cycles of ESNO respectively, an episode typically lasts for about one year, and on average El Niño and La Niña occur every 2-7 years. For more information on El Niño and La Niña, click [here](https://www.americangeosciences.org/critical-issues/faq/what-are-el-nino-and-la-nina)

The animation above shows signs of El Niño for 2019, highlighted by the influx of warmer water in the equatorial Pacific.

## Data Conversion

The world map animation above is monthly sea surface temperature (SST) for 2019. Sea surface temperature is measured by deploying sensors on satellites, buoys, and ships. This data is from the Copernicus' Climate Change Service[^Copernicus]. It was downloaded [here](https://cds.climate.copernicus.eu/cdsapp#!/home) from the Climate Data Store.
...
def createRaster(np_array, no_data, lowerLeft, xcell, year, var):
    ...
    file_path = './output/' + var + '_raster_'+ str(year)+ '.tif'
