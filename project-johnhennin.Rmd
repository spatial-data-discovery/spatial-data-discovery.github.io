...
<div class="video-wrapper">
  <video width="400" height="400" id="scaledvideo" controls preload="true" autoplay loop muted>
...
## Overview
Too many people utilize an "out of sight, out of mind" approach when it comes to the gradually diminishing sea ice of the North and South Poles.
...
Using the Python[^python] programming language and the package rasterio[^rasterio], the GeoTIFFs were converted to ASCII[^ascii] raster files to allow for easier future manipulation and analysis.
To preserve the Coordinate Reference System information in each GeoTIFF, the script pulled the relevant information from the file and reproduced it in a supplementary PRJ[^prj] file.
