...
## Sample Script
[randomPassword.py](scripts/randomPassword.py)

I made this script so it can randomly generate passwords of a given length. 
A random seed can be given, that way someone can track the random seed and length 
they used for different websites, and regenerate the passwords when they forget them.

<audio controls>
<source src="audio/randomPassword.mp3">
</audio>
