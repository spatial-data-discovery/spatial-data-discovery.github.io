...
### Wind Data
To successfully visualize the wind data, one first needs to use Panoply. Import both the of the wind data files (uwnd_data.nc, vwnd_data.nc), then create a combined plot of both files. Lastly, select "vector magnitude" in how the two arrays are calculated to be visualized. 
