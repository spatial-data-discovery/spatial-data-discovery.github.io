...
:   - Fall 2020 (19 August 2020--24 November 2020)

Location

:   - [Integrated Science Center](https://www.wm.edu/about/visiting/campusmap/location/isc-1.php) Room 3280

        \*_classes will likely be held remotely_
...
:   - This class is labeled as MIX/RSOF, which means that the class meets remotely at a synchronous class time.
        There may be optional in-class/in-person scheduled meetings, but is unlikely.

Final Exam

:   - Semester-long project due on or before 24 November 2020
...
:   - Instant messaging using [GroupMe](https://groupme.com/)
    ...
    - Video conferencing ([Zoom](https://cwm.zoom.us/))
        - Video conferencing is for class meetings, office hours, video chats, and any other meetings where "face-to-face" communication or screen sharing is required
    ...
    - Organization Website (https://spatial-data-discovery.github.io/)
        - The public-facing organization site for Spatial Data Discovery class; you will be added to the GitHub Development Team as a Coder and have your final project displayed.
        - This site is maintained by your instructor, but you will submit three assignments to the linked repository (see The Organization Repository)
    - GitHub Team Website (https://github.com/orgs/spatial-data-discovery/teams/f20-developers)
    ...
    - Repositories
        ...
        - The Semester Repository (https://github.com/spatial-data-discovery/ay2021-1)
...
:   - Announcements, discussions, course calendar, grades, etc., will be related to you through the university's [Blackboard](https://blackboard.wm.edu); please make certain you have access to it.
    ...
    - Scripting assignments will be tested and graded using [Python 3.7](https://www.python.org/) or later; please be sure you have a recent version installed.
