...
1. Discussions [[LE \#6,8](#learning-expectations)]
1. Exam [[LE \#1,2,4,5](#learning-expectations)]
1. Report [[LE \#3,8,9](#learning-expectations)]
1. Project [[LE \#7,8,9](#learning-expectations)]
...
:   Students are required to publish an up-to-date work journal throughout the semester.
    A student that fails to do so by the last day of class will receive a failing grade for the class.
...
Weekly Quizzes
:   Weekly (ungraded) Blackboard quizzes are assigned to assist you with the completion of the final exam; each missed (scoring <60%) or skipped quiz reduces your final grade by 1/2 step; therefore, by definition, if you miss or skip more than 10 quizzes, your maximum score is an F.
...
2. **Assignments** (75 points): Students are asked to complete the six (6) graded assignments described below.
