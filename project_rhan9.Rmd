...
![13-14 Season, Age: 19](https://drdavis.space/teaching/ds/sdd/media/2020/05/GA13.png) ![14-15 Season, Age: 20](https://drdavis.space/teaching/ds/sdd/media/2020/05/GA14.png)
![15-16 Season, Age: 21](https://drdavis.space/teaching/ds/sdd/media/2020/05/GA15.png) ![16-17 Season, Age: 22](https://drdavis.space/teaching/ds/sdd/media/2020/05/GA16.png)
![17-18 Season, Age: 23](https://drdavis.space/teaching/ds/sdd/media/2020/05/GA17.png) ![18-19 Season, Age: 24](https://drdavis.space/teaching/ds/sdd/media/2020/05/GA18.png)
![19-20 Season, Age: 25](https://drdavis.space/teaching/ds/sdd/media/2020/05/GA19.png)
...
After the court was created, I used to plot all shots using the x,y locations from each year's Pandas dataframe.
...
The fill colors were removed so the overlapping circles are a bit easier to see.
...
Even though the 19-20 season ended prematurely, Giannis was on record to attempt and make more shots than he had in all previous seasons.
...
[^tutorial]: Savvas Tjortjoglous's Python tutorial to create basketball court. Accessed 2020-0505 Online: http://savvastjortjoglou.com/nba-shot-sharts.html
